...
test_that("padroniza corretamente", {
  ...
  expect_equal(padronizar_numeros(""), NA_character_)
  ...
  expect_equal(padronizar_numeros(NA_character_), NA_character_)

  expect_equal(padronizar_numeros(1), "1")
  expect_equal(padronizar_numeros(NA_integer_), NA_character_)
  expect_equal(padronizar_numeros(c(1, 2000, NA)), c("1", "2000", NA_character_))
})
